#!/usr/bin/env python3
"""Build a minimal *seed* bundle for market-open (~40 minutes after open).

Goal: capture *intraday* pulse + portfolio risks, and provide enough context for
an LLM planner to decide what symbols to fetch (company + history) for a
non-hallucinated market-open action plan.
