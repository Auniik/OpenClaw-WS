#!/usr/bin/env python3
"""Pre-market runner (deterministic paths + bundler).
...
def main() -> None:
    ...
    data_dir = state_root / run_date / "pre-market"
    ...
    bundler = Path("/Users/anik/.openclaw/workspace/skills/dse-trading/scripts/pre-market/bundler.py")
